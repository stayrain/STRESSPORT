...
void main (void) {
    ...
    gl_FragColor = vec4(vec3(concentricCircles(st, vec2(1.0,0.0), 5.0, 5.0),concentricCircles(st, vec2(0.0,0.0), 10.0, 10.0),concentricCircles(st, vec2(0.0,0.0), 20.0, 10.0)),1.0);
}
